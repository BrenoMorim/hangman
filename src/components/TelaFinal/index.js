...
export default function TelaFinal({resultadoJogo}) {
    ...
    return (
        <View style={estilos.telaFinal}>
            ...
            <TouchableOpacity style={estilos.botao}><Text style={estilos.botaoTexto}>Jogar Novamente</Text></TouchableOpacity>
            <TouchableOpacity style={estilos.botao}><Text style={estilos.botaoTexto}>Página Inicial</Text></TouchableOpacity>
        </View>
    );
}
